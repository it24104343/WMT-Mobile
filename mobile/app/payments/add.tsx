...
export default function RecordPaymentScreen() {
  ...
  const [form, setForm] = useState({
    paymentType: isAdmin ? 'TEACHER_SALARY' : (params.type === 'TEACHER_SALARY' ? 'TEACHER_SALARY' : 'CLASS_FEE'),
    targetId: '', 
    targetName: '',
    amount: '',
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.inputWrapper}>
            ...
            >
              <Ionicons 
                name={form.paymentType === 'TEACHER_SALARY' ? 'person-outline' : 'book-outline'} 
                size={20} 
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>{form.paymentType === 'TEACHER_SALARY' ? 'Salary Month' : 'Payment Month'}</Text>
        ...
        {form.paymentMethod === 'BANK_TRANSFER' && (
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>{form.paymentType === 'TEACHER_SALARY' ? 'Salary Slip' : 'Payment Receipt'}</Text>
            <TouchableOpacity style={styles.uploadBox} onPress={handlePickSlip}>
              {slip ? (
                <View style={styles.slipPreview}>
                  ...
                  <Text style={styles.slipText}>Image Selected</Text>
                </View>
              ) : (
                <View style={styles.uploadPlaceholder}>
                  <Ionicons name="cloud-upload-outline" size={40} color={Colors.dark.textMuted} />
                  <Text style={styles.uploadText}>Upload {form.paymentType === 'TEACHER_SALARY' ? 'Salary Slip' : 'Payment Receipt'}</Text>
                </View>
              )}
            </TouchableOpacity>
          </View>
